...
export const SYSTEMS: {id:SystemId;name:string;color:string;description:string}[] = [
 ...
 {id:'pregnancy',name:'Pregnancy reference',color:'#b88380',description:'The placenta and umbilical cord support exchange between maternal and fetal circulations during pregnancy. Visible pregnancy structures are accompanied by an illustrative abdominal surface, which does not represent a specific gestational age.'},
